...
ESCALATION_LOG_FILE = LOGS_DIR / "escalation_log.json"
SUMMARY_LOG_FILE = LOGS_DIR / "session_summaries.json"
...
def log_escalation(
    ...
    """Append an escalation event to escalation_log.json."""
...
def log_summary(session_id: str, summary: dict):
    """Append a session summary to session_summaries.json."""
