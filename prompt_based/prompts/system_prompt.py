...
from sop import get_sop_as_text

def build_system_prompt() -> str:
    sop_text = get_sop_as_text()
...
# STAGE-SPECIFIC PROMPT SNIPPETS (injected as user-side instructions)

QUALIFICATION_PROMPT = """Support them conversationally. Recommend relevant plans naturally and ask one contextual question if needed to refine recommendations, without interrogating."""

SUMMARY_PROMPT = """The conversation is wrapping up. Generate the session_complete=true response.
Your 'message' field should be a warm closing line.
Make sure qualification_data is fully populated with all collected details."""
